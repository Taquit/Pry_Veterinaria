...
class Enfermedad(models.Model):
    ...
    id_tipo_enfermedad = models.ForeignKey(TipoEnfermedad, on_delete=models.CASCADE,db_column='id_tipo_enfermedad')
    ...
    id_gravedad = models.ForeignKey(NivelGravedad, on_delete=models.CASCADE,db_column='id_gravedad')
    id_subtipo = models.ForeignKey(Subtipo, on_delete=models.CASCADE,db_column='id_subtipo')
    id_edad_predispuesta = models.ForeignKey(CatalogoEdadPredispuesta, on_delete=models.CASCADE,db_column='id_edad_predispuesta')
...
class Alergia(models.Model):
    ...
    sintomas = models.TextField(blank=True, null=True)
    tratamiento = models.TextField(blank=True, null=True)
    id_tipo_alergia = models.ForeignKey(TipoAlergias, on_delete=models.CASCADE,db_column='id_tipo_alergia')
    id_gravedad = models.ForeignKey(NivelGravedad, on_delete=models.CASCADE,db_column='id_gravedad')
    id_subtipo = models.ForeignKey(Subtipo, on_delete=models.CASCADE,db_column='id_subtipo')
    id_edad_predispuesta = models.ForeignKey(CatalogoEdadPredispuesta, on_delete=models.CASCADE,db_column='id_edad_predispuesta')
    clasificacion = models.CharField(max_length=50, blank=True, null=True)
...
class Vacuna(models.Model):
    ...
    id_importancia = models.ForeignKey(NivelImportancia, on_delete=models.CASCADE,db_column='id_importancia')
    id_tipo = models.ForeignKey(Tipo, on_delete=models.CASCADE,db_column='id_tipo')
    id_tipo_vacuna = models.ForeignKey(CatalogoTipoVacuna, on_delete=models.CASCADE,db_column='id_tipo_vacuna')
    descripcion = models.TextField(blank=True, null=True)
...
class VacunaPrevieneEnfermedad(models.Model):
    ...
    id_enfermedad = models.ForeignKey(Enfermedad, on_delete=models.CASCADE,db_column='id_enfermedad')
...
class CodigoPostal(models.Model):
    ...
    id_mnpio = models.ForeignKey(Municipio, on_delete=models.CASCADE,db_column='id_mnpio')
...
class Asentamiento(models.Model):
    ...
    codigop = models.ForeignKey(CodigoPostal, on_delete=models.CASCADE,db_column='codigop')
    id_tipo_asenta = models.ForeignKey(TipoAsentamiento, on_delete=models.CASCADE, null=True,db_column='id_tipo_asenta')
...
class Domicilio(models.Model):
    ...
    id_asenta = models.ForeignKey(Asentamiento, on_delete=models.CASCADE,null=True,db_column='id_asenta')
...
class Dueno(models.Model):
    ...
    id_domicilio = models.ForeignKey(Domicilio, on_delete=models.CASCADE,db_column='id_domicilio')
...
class ContactoEmergencia(models.Model):
    ...
    telefono = models.CharField(max_length=13)
    correo = models.EmailField(max_length=255)
    id_dueno = models.OneToOneField(Dueno, on_delete=models.CASCADE,db_column='id_dueno')
...
class MascotaBase(models.Model):
    ...
    sexo = models.ForeignKey(CatalogoSexo, on_delete=models.CASCADE,db_column='sexo')
    id_dueno = models.ForeignKey(Dueno, on_delete=models.CASCADE,db_column='id_dueno')
    id_subtipo = models.ForeignKey(Subtipo, on_delete=models.CASCADE,db_column='id_subtipo')
...
class MascotaFisica(models.Model):
    ...
    id_mascota = models.ForeignKey(MascotaBase, on_delete=models.CASCADE,db_column='id_mascota')
    tamano = models.IntegerField(null=True, blank=True)
    peso = models.IntegerField(null=True, blank=True)

class MascotaColor(models.Model):
    id_mascota = models.ForeignKey(MascotaBase, on_delete=models.CASCADE,db_column='id_mascota')
    id_color = models.ForeignKey(Color, on_delete=models.CASCADE,db_column='id_color')
    tipo_color = models.ForeignKey(TipoColor, on_delete=models.CASCADE,db_column='tipo_color')
    id_patron = models.ForeignKey(CatalogoPatron, on_delete=models.CASCADE,db_column='id_patron')
...
class MascotaAlergias(models.Model):
    ...
    fecha_diagnostico = models.DateField()
    id_severidad = models.ForeignKey(CatalogoSeveridad, on_delete=models.CASCADE, null=True,db_column='id_severidad')
    notas = models.TextField(blank=True, null=True)
...
class Habitacion(models.Model):
    ...
    id_status = models.ForeignKey(EstatusHabit, on_delete=models.CASCADE,db_column='id_status')
    id_tipo_habitacion = models.ForeignKey(TipoHabitacion,on_delete=models.PROTECT,db_column='id_tipo_habitacion')
...
class Reservaciones(models.Model):
    ...
    id_mascota = models.ForeignKey(MascotaBase,null=True, on_delete=models.CASCADE,db_column='id_mascota')
    id_empleado = models.ForeignKey(Empleado,null=True, on_delete=models.CASCADE,db_column='id_empleado')
    id_dueno = models.ForeignKey(Dueno, on_delete=models.CASCADE,db_column='id_dueno')
    id_status = models.ForeignKey(EstatusReservacion, on_delete=models.CASCADE,db_column='id_status')
...
class BitacoraPaseo(models.Model):
    ...
    id_reservacion = models.ForeignKey(Reservaciones, on_delete=models.CASCADE,db_column='id_reservacion')
...
class LimpiezaHabitacion(models.Model):  
    ...
    no_habit = models.ForeignKey(Habitacion, on_delete=models.CASCADE,db_column='no_habit')
